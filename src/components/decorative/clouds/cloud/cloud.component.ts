...
export class CloudComponent implements OnInit {
  ...
  calculatedDistance = computed(() => {
    return this.distance ? MATH.clamp(this.distance(), 0.1, Number.MAX_SAFE_INTEGER) : 1;
  })
  ...
  getZIndex() {
    return MATH.denormalize(this.calculatedDistance(), this.BACK_CLOUD_Z, this.FORE_CLOUD_Z, true);
  }
